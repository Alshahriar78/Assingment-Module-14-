...
const NavBar = (props) => {
    ...
    return (
        ...
        <>
            <div className="navbar  fixed top-0 z-50 bg-green-200 ">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost normal-case text-xl text-black">Design<span className='text-orange-500'>AGENCY</span></a>
                </div>
