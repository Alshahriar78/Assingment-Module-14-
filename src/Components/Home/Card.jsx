        ...
        <div className='bg-green-200 pt-5 pb-5 mt-5'>
            ...
            <div className=" bg-green-100 h-28 ">
                <div className="flex  justify-evenly p-10">
                    ...
                    <img className="" alt="Google Logo" src="images/google.png"/>
                    <img className="" alt="trello Logo" src="images/trello.png"/>
                    <img className="" alt="trello Logo" src="images/monday.png"/>
                    <img className="" alt="trello Logo" src="images/notion.png"/>
                    <img className="" alt="trello Logo" src="images/slack.png"/>
